...
export default class GeomagicWrapTool extends Tool<GeomagicWrapTool, IGeomagicWrapToolSettings>
{
    ...
    async setupInstance(instance: GeomagicWrapInstance): Promise<IToolSetup>
    {
        ...
        const content = [
            ...
            ``,
            `try:`,
            `   geo.set_option('Advanced/Conditioning/Target Triangles', 50000000)`,
            `   geo.set_option('Advanced/Conditioning/Chunk Size', 25000000)`,
            `   geo.open(0, 1, u${JSON.stringify(inputFilePath)})`,
            `   geo.modify_units(1, 0, ${inUnit})`,
            `   geo.modify_units(0, 1, ${outUnit})`,
            `   geo.mesh_doctor("defeatureoption", 2, "fillholeoption", 2, "autoexpand", 2, "operations", "IntersectionCheck+", "SmallComponentCheck+", "SpikeCheck+", "HighCreaseCheck+", "Update", "Auto-Repair")`,
