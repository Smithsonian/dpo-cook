...
export default class LegacyTool extends Publisher
{
    ...
    get type(): typeof LegacyTool
    {
        return this.constructor as typeof LegacyTool;
    }
    ...
    {
        return (this.constructor as typeof LegacyTool).configuration;
    }
    ...
    {
        const defaultOptions = (this.constructor as typeof LegacyTool).defaultOptions;
